...
import { OngoingScheduleForm } from '../components/ongoing-schedule-form'
import { OngoingScheduleList } from '../components/ongoing-schedule-list'
import { Schedule } from '../page'

const topNav = [
  {
    title: 'Ongoing Meetings',
    href: 'schedule/ongoing',
    isActive: true,
    disabled: false,
  },
]
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full gap-4 mb-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="sm:w-auto">
              <TabsList className="grid w-full sm:w-auto grid-cols-2 sm:grid-cols-3">
                <TabsTrigger value="list" className="text-xs sm:text-sm">Ongoing Meetings</TabsTrigger>
            ...
            {activeTab === 'list' && (
              <Card>
                ...
                <CardContent className="p-4 md:p-6">
                  <OngoingScheduleList onEdit={handleEdit} />
                </CardContent>
              </Card>
            )}
