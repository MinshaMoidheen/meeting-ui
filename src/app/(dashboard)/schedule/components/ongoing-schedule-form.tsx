    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-muted/50 p-4 rounded-lg">
          <h4 className="text-sm font-medium mb-2">Ongoing Meeting Guidelines</h4>
          <ul className="text-xs text-muted-foreground space-y-1">
            <li>• Title: 3-100 characters describing the ongoing meeting/event</li>
            <li>• Description: 10-500 characters with meeting details and agenda</li>
            <li>• Date & Time: Select today's date and any time</li>
