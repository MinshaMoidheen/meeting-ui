    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-muted/50 p-4 rounded-lg">
          <h4 className="text-sm font-medium mb-2">Previous Meeting Guidelines</h4>
          <ul className="text-xs text-muted-foreground space-y-1">
            <li>• Title: 3-100 characters describing the previous meeting/event</li>
            <li>• Description: 10-500 characters with meeting details and agenda</li>
            <li>• Date & Time: Select past dates and times (before today)</li>
            <li>• Location: Specify where the meeting took place</li>
            ...
            <li>• Organizer: Name of the person who organized the meeting</li>
          </ul>
        </div>
